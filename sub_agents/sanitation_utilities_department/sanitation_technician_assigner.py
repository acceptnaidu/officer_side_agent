...
def get_available_technicians(department="Sanitation Utilities"):
    """
...
def assign_sanitation_ticket(ticket_id: int, assigned_work_date: str):
    """
    ...
    """
    available_techs = get_available_technicians("Sanitation Utilities")
