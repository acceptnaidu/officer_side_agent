...
def get_available_technicians(department="Parks Community Civic"):
    """
...
def assign_civic_ticket(ticket_id: int, assigned_work_date: str):
    """
    ...
    """
    available_techs = get_available_technicians("Parks Community Civic")
